//поделючение апи нужно будет тут q={city} написаить город,а тут appid={ a8a4f533337b1b9090c9d61997ae1874} апи ключ его можно взять тут-https://openweathermap.org/api/one-call-3
fetch('https://api.openweathermap.org/data/2.5/weather?q={city}&appid={ a8a4f533337b1b9090c9d61997ae1874}&units=metric')
